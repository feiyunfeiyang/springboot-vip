...
public class DatabaseMetaUtil {
    ...
    private final static String DATABASE_NAME = "recruit";
    ...
    private void getDatabaseMetaData() {
        try {
            if (dbMetaData == null) {
                ...
                String url = "jdbc:mysql://localhost:3306/"+DATABASE_NAME+"?serverTimezone=UTC&useUnicode=true&characterEncoding=utf-8&zeroDateTimeBehavior=convertToNull&useSSL=false";
                String user = "root";
    ...
    public static void main(String[] args) {
        ...
        metaData.getTableColumns("root", "fb_talent_database");
        // System.out.println("=======================");
        // metaData.getIndexInfo("root", "gen_person");
        // System.out.println("=======================");
        //metaData.getAllPrimaryKeys("root", "fb_talent_database");
        // System.out.println("=======================");
